    ...
    <section className="bg-white rounded-lg shadow-sm border border-slate-200 overflow-hidden min-h-[500px]">
      ...
      {tab === 'pending' && (
        <div className="p-6 text-center">
          <p className="text-sm text-gray-500 mb-4">选择评价类型，提交您的培训反馈</p>
          <div className="flex gap-4 justify-center">
            <button
              type="button"
              onClick={() => setReviewOpen(true)}
              className="px-6 py-2.5 bg-primary text-white rounded-md hover:bg-primary/90 transition-colors text-sm font-medium"
            >
              评价课程/专家
            </button>
          </div>
