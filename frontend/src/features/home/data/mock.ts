...
/**
 * 推荐专家（首页 6+3+3 混合布局）
 * TODO: 替换为接口 GET /trainer?featured=true
 */
...
export const popularInternalCourses: InternalCourse[] = [
  {
    ...
    subtitle: '定制化方案 • 线下授课',
    coverUrl: '/statics/images/case-1.jpg',
    instructorName: '徐老师',
  ...
  },
  {
    ...
    title: '《非财务经理的财务管理实务》',
    subtitle: '决策支持 • 数据分析',
    coverUrl: '/statics/images/course-1.jpg',
    instructorName: '陈老师',
  ...
  },
  {
    ...
    title: '《全栈产品经理能力提升工坊》',
    subtitle: '全流程闭环 • 实操演练',
    coverUrl: '/statics/images/public-course-1.jpg',
    instructorName: '林老师',
  ...
  },
  {
    ...
    title: '《卓越领导力：从管理到赋能》',
    subtitle: '组织心理学 • 绩效提升',
    coverUrl: '/statics/images/hero-banner.jpg',
    instructorName: '张教授',
...
export const upcomingPublicCourses: PublicCourse[] = [
  ...
  },
  {
    ...
    coverUrl: '/statics/images/public-course-2.jpg',
    organizer: 'CSTD',
