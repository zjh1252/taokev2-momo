-- 培训宝 legacy：video_package_labels 对齐老站 tk_video_topic_item 层级字段
-- 可重复执行
...
BEGIN
    ...
    IF NOT EXISTS (
        ...
        ALTER TABLE video_package_labels ADD COLUMN price INT NOT NULL DEFAULT 0 COMMENT '包售价（元，整数）';
    END IF;
